...
const HeroSection = () => {
  return (
    <section className="mt-8 mx-auto w-[90%] h-auto
    p-8 bg-white/30 
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2 lg:my-14">
                <div className="flex flex-col items-center justify-start text-neutral-900">
                    <p className="font-light text-3xl lg:text-4xl bg-gradient-to-r from-red-700 to-neutral-900 text-transparent bg-clip-text">Ольга Вітюк</p>
            ...
            <div className="w-full lg:w-1/2 lg:p-8 mt-10 lg:mt-6">
                <div className="flex justify-center">
                    <img className="rounded-lg w-full max-w-[380px] min-w-[280px] h-auto object-cover" src={hero} alt="PHOTO"/>
                </div>
            </div>
        </div>
    </section>
