...
export const ABOUT_TEXT = `Я допомагаю людям знайти гармонію з собою, відновити емоційний баланс та розпізнати глибинні переконання, що стоять на шляху до щасливого життя. У своїй практиці я поєдную інтуїцію, досвід і техніки Тета Практики, створюючи безпечний простір для внутрішньої трансформації. Моя мета - допомогти кожному відчути себе почутим, зрозумілим і сильним.`;
